  ...
  transition('* <=> *', [
    ...
    group([
      query(
        ...
        [
          ...
          animate(
            '0.5s ease-in',
            style({ clipPath: 'polygon(50% 0, 50% 0, 50% 100%, 50% 100%)' }) // Close doors
          ),
        ],
        { optional: true }
      ),
    ...
    group([
      query(
        ':enter',
        [
          style({ clipPath: 'polygon(50% 0, 50% 0, 50% 100%, 50% 100%)' }), // Doors closed
          animate(
            '0.5s ease-out',
            style({ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' }) // Open doors
          ),
        ],
        { optional: true }
      ),
